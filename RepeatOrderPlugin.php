 ...
 *
 * Repeat an order within Craft Commerce from a user accounts order history
 *
 * --snip--
...
class RepeatOrderPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Repeat an order within Craft Commerce from a completed orders history');
    }
